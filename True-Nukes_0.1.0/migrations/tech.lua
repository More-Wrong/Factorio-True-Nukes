for index, force in pairs(game.forces) do
  ...
  if mods["SchallTankPlatoon"] then
    ...
    if(settings.startup["enable-thermobaric"].value) then
      recipes["thermobaric-autocannon-shell"].enabled = technologies["thermobaric-weaponary"].researched
      recipes["thermobaric-cannon-H1-shell"].enabled = technologies["thermobaric-weaponary"].researched
      recipes["thermobaric-cannon-H2-shell"].enabled = technologies["thermobaric-weaponary"].researched
    end
  end
  recipes["small-atomic-artillery-shell"].enabled = technologies["atomic-artillery-shells"].researched
  recipes["atomic-artillery-shell"].enabled = technologies["atomic-artillery-shells"].researched
  recipes["big-atomic-artillery-shell"].enabled = technologies["atomic-artillery-shells"].researched
  if(settings.startup["enable-thermobaric"].value) then
    recipes["fire-shield-equipment"].enabled = technologies["atomic-bomb"].researched or technologies["thermobaric-weaponary"].researched
    recipes["thermobaric-cannon-shell"].enabled = technologies["thermobaric-weaponary"].researched
    recipes["thermobaric-rocket"].enabled = technologies["thermobaric-weaponary"].researched
    recipes["thermobaric-artillery-shell"].enabled = technologies["thermobaric-weaponary"].researched
  else
  ...
  recipes["very-big-atomic-artillery-shell"].enabled = technologies["scary-atomic-weapons"].researched
end
