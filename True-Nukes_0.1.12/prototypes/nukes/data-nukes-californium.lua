...
atomic_cannon_item.ammo_type.range_modifier = 5
atomic_cannon_item.ammo_type.action.action_delivery.max_range = 150
atomic_cannon_item.ammo_type.cooldown_modifier = 6
...
big_atomic_cannon_item.ammo_type.action.action_delivery.max_range = 90
...
small_atomic_bomb_item.ammo_type.range_modifier = 2
...
very_small_atomic_bomb_item.ammo_type.range_modifier = 1.5
...
really_very_small_atomic_bomb_item.ammo_type.range_modifier = 1
